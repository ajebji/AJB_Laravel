...
@section('content')
        ...
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="flex md:order-2">
                <button type="button"
                    ...
                    started</button>
                <button data-collapse-toggle="navbar-sticky" type="button" id="menu-button"
    ...
    <section class="bg-white dark:bg-gray-900 mt-16">
        <div class="py-16 px-4 mx-auto max-w-screen-xl text-center lg:py-16 z-10 relative">
            <a href="#" class="inline-flex justify-between items-center py-1 px-1 pr-4 mb-7 text-sm text-blue-700 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-300 hover:bg-blue-200 dark:hover:bg-blue-800">
                <span class="text-xs bg-blue-600 rounded-full text-white px-4 py-1.5 mr-3">New</span> <span class="text-sm font-medium">New Component was launched! See what's new</span>
    ...
    <footer class="fixed bottom-0 left-0 z-20 w-full p-4 bg-white border-t border-gray-200 shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800 dark:border-gray-600">
        <div class="w-full text-center">
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400"> Ayoub JEBJI © 2023 All Rights Reserved.</span>
        </div>
    </footer>
